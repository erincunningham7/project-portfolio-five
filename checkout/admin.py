...
class OrderAdmin(admin.ModelAdmin):
    ...
    field = ('date', 'user_profile', 'order_number', 'full_name', 'phone_number', 'email', 'street_address1', 'street_address2', 'town_or_city', 'county', 'country', 'postcode', 'town_or_city', 'delivery_cost', 'order_total', 'grand_total',)
